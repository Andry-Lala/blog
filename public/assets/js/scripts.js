...
(function($) {
	...
	// Ignorer les liens avec data-no-jquery="true" pour éviter les conflits avec Alpine.js
	$('a[data-no-jquery="true"]').off('click').on('click', function(e) {
		// Laisser Alpine.js gérer ces liens
		return true;
	});
