...
@section('header')
    <div class="ml-4 flex items-center justify-between">
        <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Modifier le Client</h1>
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
            <form action="{{ route('clients.update', $client) }}" method="POST" class="p-6">
                ...
                <div class="mt-8">
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">Laissez vide si vous ne souhaitez pas modifier le mot de passe</p>
