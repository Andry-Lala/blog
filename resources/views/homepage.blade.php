    ...
    <body data-spy="scroll" data-target=".fixed-top">
            ...
            <div class="container sm:px-4 lg:px-8 flex flex-wrap items-center justify-between lg:flex-nowrap">
                ...
                <div class="navbar-collapse offcanvas-collapse lg:flex lg:flex-grow lg:items-center" id="navbarsExampleDefault">
                    <ul class="pl-0 mt-3 mb-2 ml-auto flex flex-col list-none lg:mt-0 lg:mb-0 lg:flex-row">
                        ...
                        <li>
                            <a id="service_nav_link" class="nav-link page-scroll" href="#services">Services</a>
                        </li>
                        <li>
                            <a class="nav-link page-scroll" id="plan_nav_link" href="#plan">Investment Plan</a>
                        </li>
                        <li class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdown01">
                                <a id="about_us_drop" class="dropdown-item page-scroll popup-with-move-anim" href="#details-about-us">About Us</a>
                                <div class="dropdown-divider"></div>
                                <a id="terms_of_use_drop" class="dropdown-item page-scroll popup-with-move-anim" href="#details-term-of-use">Terms of Use</a>
                                <div class="dropdown-divider"></div>
                                <a id="privacy_policy_drop" class="dropdown-item page-scroll popup-with-move-anim" href="#details-privacy-policy">Privacy Policy</a>
                                <div class="dropdown-divider"></div>
                                <a id="cookies_policy_drop" class="dropdown-item page-scroll popup-with-move-anim" href="#details-cookies">Cookies Policy</a>
                            </div>
                        </li>
                        <li>
                            <div class="flex space-x-4 items-center">
                                ...
                                <div class="relative inline-block w-40">
                                    ...
                                    <select id="languageDropdown" class="border border-gray-300 bg-white text-gray-700 px-10 py-3 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 w-34">
                ...
                <div class="mb-16  xl:mr-12">
                    ...
                    <div class="grid grid-rows-1 gap-3 p-3 lg:-ml-10 lg:-mt-16">
                        ...
                        <!-- Sécurité Paiement -->
                            <div class="group flex flex-col items-center text-center lg:items-start lg:text-left">
                                <div class="w-20 h-20 rounded-full bg-blue-500 flex items-center justify-center shadow-md group-hover:bg-teal-600 group-hover:shadow-xl transition-all duration-300 border-blue-500 border-2">
                                    <h3 id="payment_badge" class=" text-sm font-semibold text-white">PAYMENT</h3>
                                </div>
                                <p id="payment_text" class="mt-1 text-sm text-gray-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        ...
                        <!-- Fiabilité -->
                            <div class="group flex flex-col items-center text-center lg:items-start lg:text-left">
                                <div class="w-20 h-20 rounded-full bg-blue-500 flex items-center justify-center shadow-md group-hover:bg-teal-600 group-hover:shadow-xl transition-all duration-300 border-blue-500 border-2">
                                    <h3 id="security_badge" class="text-sm font-semibold text-white">SECURITY</h3>
                                </div>
                                <p id="security_text" class="mt-1 text-sm text-gray-500 opacity-0 group-hover:opacity-100  transition-opacity duration-300">
                        ...
                        <!-- Rapidité Transfert -->
                            <div class="group flex flex-col items-center text-center lg:items-start lg:text-left">
                                <div class="w-20 h-20 rounded-full bg-blue-500 flex items-center justify-center shadow-md group-hover:bg-teal-500 group-hover:shadow-xl transition-all duration-300 border-blue-500 border-2">
                                    <h3 id="transfer_badge" class="text-sm font-semibold text-white">TRANSFER</h3>
                                </div>
                                <p id="transfer_text" class="mt-1 text-sm text-gray-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    ...
                    <h1 id="home_title" class="h1-large mb-5 ">Invest <span class="text-red-500 font-bold">in</span> <br>Earn <span class="text-red-500 font-bold">Money</span> <br>Get <span class="text-red-500 font-bold">Paid</span></h1>
                    <p id="home_text" class="p-large mb-8">Come in to check out our online offers</p>
                    <a id="sign_up" class="btn-solid-lg px-4 py-2 text-sm" href="/register"><i class="fas fa-user-plus fa-sm mr-2"></i>Sign up now</a>
                </div>
        ...
        <div class="py-22 my-24">
            <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-12 lg:gap-x-12" >
                ...
                <div class="lg:col-span-5">
                    <div class="xl:mt-2">
                        <h2 id="service_title" class="mb-6">Our Services</h2>
                        <div class="max-w-xl mx-auto">
                            <p id="text_paragraph" class="text-gray-700 overflow-hidden h-24">Unicorn Madagascar offers a cutting-edge investment plan focused on synthetic indices, designed for investors seeking high returns in a controlled market environment. Our strategy leverages the unique characteristics of synthetic indices, which mimic real-world market volatility without being affected by external events like economic shifts or geopolitical tensions. With 24/7 availability and a transparent pricing model, our synthetic indices investment plan provides flexibility and consistent opportunities for growth. Investors benefit from advanced market insights and risk management tools, ensuring a well-balanced portfolio tailored to their risk tolerance. At Unicorn Madagascar, we help you navigate the dynamic world of synthetic indices with confidence and precision.</p>
                            <button id="toggle_btn" class="mt-2 text-blue-600 hover:underline font-medium">Read more</button>
                            <br><br><a id="service_btn_more" class="btn-solid-reg popup-with-move-anim mr-1.5" href="#details-service">Learn more about our service</a>
                        </div>
                    </div>
                </div> <!-- end of col -->
            </div> <!-- end of container -->
        ...
        <div id="details-service" class="lightbox-basic zoom-anim-dialog mfp-hide">
            ...
            <div class="lg:grid lg:grid-cols-12 lg:gap-x-8">
                ...
                <div class="lg:col-span-12">
                    <h3 id="service_title_details" class="mb-2">Our Services</h3>
                    <hr class="w-11 h-0.5 mt-0.5 mb-4 ml-0 border-none bg-indigo-600" />
                    <h6 id="title_serv_1" class="mt-7 mb-2.5">Unicorn Madagascar's Synthetic Indices Investment Service</h6>
        ...
        <div id="details-term-of-use" class="lightbox-basic zoom-anim-dialog mfp-hide">
            <div class="lg:grid lg:grid-cols-12 lg:gap-x-8">
                <button title="Close (Esc)" type="button" class="mfp-close x-button">×</button>
                <div class="lg:col-span-12">
                    <h3 id="term_of_use_title" class="mb-2">Terms of Use</h3>
                    <hr class="w-11 h-0.5 mt-0.5 mb-4 ml-0 border-none bg-indigo-600" />
                    <h6 id="tou_h1" class="mt-7 mb-2.5">1. Acceptance of Terms :</h6>
                    <p id="tou_p1" >By accessing or using Online job portal, you agree to comply with and be bound by these Terms of Use. If you do not agree with these terms, please do not use the Website.</p>
                    <h6 id="tou_h2" class="mt-7 mb-2.5">2. User Accounts :</h6>
                    <p id="tou_p2_1">2.1 You may need to create a user account to access certain features of the Website. You are responsible for maintaining the confidentiality of your account information and agree to accept responsibility for all activities that occur under your account.</p>
                    <p id="tou_p2_2">2.2 You must provide accurate and complete information when creating an account.</p>
                    <h6 id="tou_h3" class="mt-7 mb-2.5">3. User Conduct :</h6>
                    <p id="tou_p3_1">3.1 You agree to use the Website only for lawful purposes and in a manner that does not infringe upon the rights of others or restrict their use and enjoyment of the Website.</p>
                    <p id="tou_p3_2">3.2 You agree not to engage in any unauthorized access, data mining, or any activity that disrupts or interferes with the Website's functionality.</p>
                    <h6 id="tou_h4" class="mt-7 mb-2.5">4. Content :</h6>
                    <p id="tou_p4_1">4.1 Users may submit content, including job postings, resumes, and reviews. By submitting content, you grant Online Job Portal a non-exclusive, royalty-free, perpetual, and worldwide license to use, modify, and distribute the content.</p>
                    <p id="tou_p4_2">4.2 You agree not to submit false, misleading, or offensive content.</p>
                    <h6 id="tou_h5" class="mt-7 mb-2.5">5. Intellectual Property :</h6>
                    <p id="tou_p5_1">5.1 The Website and its original content (excluding user-generated content) are owned by us and are protected by intellectual property laws.</p>
                    <p id="tou_p5_1">5.2 You may not use the Website's content without explicit permission from us.</p>
                    <h6 id="tou_h6" class="mt-7 mb-2.5">6. Privacy :</h6>
                    <p id="tou_p6_1">6.1 Your use of the Website is also governed by our <a class="popup-with-move-anim underline" href="#details-privacy-policy">Privacy Policy</a>.</p>
                    <h6 id="tou_h7" class="mt-7 mb-2.5">7. Limitation of Liability :</h6>
                    <p id="tou_p7_1">7.1 We are not responsible for any damages, direct or indirect, arising from your use of the Website.</p>
                    <p id="tou_p7_2">7.2 The Website may include links to third-party websites. We are not responsible for the content or actions of these third parties</p>
                    <h6 id="tou_h8" class="mt-7 mb-2.5">8. Indemnification :</h6>
                    <p id="tou_p8">You agree to indemnify and hold us harmless from any claims, losses, or damages arising out of your use of the Website or violation of these Terms of Use.</p>
                    <h6 id="tou_h9" class="mt-7 mb-2.5">9. Termination :</h6>
                    <p id="tou_p9">We reserve the right to terminate or suspend your account and access to the Website at its sole discretion.</p>
                    <h6 id="tou_h10" class="mt-7 mb-2.5">10. Governing Law :</h6>
                    <p id="tou_p10">These Terms of Use are governed by the laws of  Jurisdiction, without regard to its conflict of law principles.</p>
                    <h6 id="tou_h11" class="mt-7 mb-2.5">11. Changes to Terms :</h6>
                    <p id="tou_p11">We reserve the right to update or modify these Terms of Use at any time without prior notice.</p>
                    <h6 id="tou_h12" class="mt-7 mb-2.5">12. Contact Us :</h6>
                    <p id="tou_p12">If you have any questions about these Terms of Use, please contact us at <a class="text-indigo-600 hover:text-gray-500" href="mailto:e.serasera.malalaka@gmail.com">e.serasera.malalaka@gmail.com</a></p>
                    <br><br>
                    <button id="tou_accept_btn" class="btn-outline-reg mfp-close as-button" type="button">I Accept</button>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div>
        ...
        <div id="details-privacy-policy" class="lightbox-basic zoom-anim-dialog mfp-hide">
            <div class="lg:grid lg:grid-cols-12 lg:gap-x-8">
                <button title="Close (Esc)" type="button" class="mfp-close x-button">×</button>
                <div class="lg:col-span-12">
                    <h3 id="pp_title" class="mb-2">Privacy Policy</h3>
                    <span id="pp_lastUp">Last updated: 08/22/2023</span>
                    <hr class="w-11 h-0.5 mt-0.5 mb-4 ml-0 border-none bg-indigo-600" />
                    <h6 class="mt-7 mb-2.5">Introduction :</h6>
                    <p id="pp_welcome">Welcome to our website. This Privacy Policy is intended to inform you about how we collect, use, disclose, and protect your personal information when you use our website [<a href="www.yourjobportalwebsite.com">www.yourjobportalwebsite.com</a>] and the services provided through it. By accessing or using the Website, you consent to the practices described in this policy</p>
                    <h6 id="pp_h1" class="mt-7 mb-2.5">Information We Collect :</h6>
                    <ol class="list-decimal ml-6">
                        <li id="pp_li1_1">Personal Information: We may collect personal information from you when you register an account, submit a job application, post a job listing, or communicate with us. This may include your name, email address, phone number, resume, and other relevant details.</li>
                        <li id="pp_li1_2">Usage Information: We collect information about how you interact with the Website, including the pages you visit, the jobs you view, and the actions you take. This data helps us improve the user experience and tailor our services to your preferences.</li>
                        <li id="pp_li1_3">Device and Log Information: We automatically collect information about the device you use to access the Website and your usage of the Website. This includes your IP address, browser type, operating system, and other technical information.</li>
                    </ol>
                    <h6 id="pp_h2" class="mt-7 mb-2.5">How We Use Your Information :</h6>
                    <p id="pp_p1">We use the information we collect for various purposes, including:</p>
                    <ol class="list-decimal ml-6">
                        <li id="pp_li2_1">Providing Services: To facilitate job searches, match job seekers with employers, and enable communication between users.</li>
                        <li id="pp_li2_2">Improving User Experience: To personalize your experience on the Website, optimize content, and provide relevant recommendations.</li>
                        <li id="pp_li2_3">Communication: To send you notifications, updates, and promotional materials related to our services.</li>
                        <li id="pp_li2_4">Analytics: To analyze trends, track usage patterns, and gather statistical data to improve our offerings.</li>
                    </ol>
                    <h6 id="pp_h3" class="mt-7 mb-2.5">Sharing Your Information :</h6>
                    <p id="pp_p2">We may share your information with the following parties:</p>
                    <ol class="list-decimal ml-6">
                        <li id="pp_li3_1">Employers and Job Seekers: Depending on your user role, we may share your information with employers or job seekers to facilitate job matching and communication.</li>
                        <li id="pp_li3_2">Service Providers: We may engage third-party service providers to assist with various aspects of our services, such as analytics, hosting, and customer support.</li>
                        <li id="pp_li3_3">Legal Compliance: We may disclose information if required by law, to protect our rights, or in response to legal requests.</li>
                    </ol>
                    <h6 id="pp_h4" class="mt-7 mb-2.5">Your Choices :</h6>
                    <ol class="list-decimal ml-6">
                        <li id="pp_li4_1">Access and Update: You can access and update your personal information through your account settings on the Website.</li>
                        <li  id="pp_li4_2">Opt-Out: You can opt out of receiving promotional emails by following the instructions provided in the email.</li>
                        <li  id="pp_li4_3">Cookies: You can manage your cookie preferences through your browser settings.</li>
                    </ol>
                    <h6  id="pp_h5" class="mt-7 mb-2.5">Security :</h6>
                    <p id="pp_p3">We implement security measures to protect your personal information from unauthorized access, alteration, disclosure, or destruction. However, no method of transmission over the internet or electronic storage is 100% secure, so we cannot guarantee absolute security.</p>
                    <h6  id="pp_h6" class="mt-7 mb-2.5">Children's Privacy :</h6>
                    <p id="pp_p4">Our services are not directed to individuals under the age of 18. We do not knowingly collect personal information from children. If you believe we have inadvertently collected such information, please contact us.</p>
                    <h6  id="pp_h7" class="mt-7 mb-2.5">Changes to this Policy :</h6>
                    <p id="pp_p5">We may update this Privacy Policy to reflect changes in our practices or applicable laws. We will notify you of any material changes via the Website or other communication methods.</p>
                    <h6 id="pp_h8" class="mt-7 mb-2.5">Contact Us</h6>
                    <p id="pp_p6">If you have any questions about this Privacy Policy, please contact us at [<a class="text-indigo-600 hover:text-gray-500" href="mailto:contact@yourjobportalwebsite.com">contact@yourjobportalwebsite.com</a>].</p>
                    <br><br>
                    <button  id="pp_accept" class="btn-outline-reg mfp-close as-button text-blue-400 border border-blue-400 hover:bg-blue-400 hover:text-white" type="button">Accept Privacy</button>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        ...
        <div id="details-cookies" class="lightbox-basic zoom-anim-dialog mfp-hide">
            <div class="lg:grid lg:grid-cols-12 lg:gap-x-8">
                <button title="Close (Esc)" type="button" class="mfp-close x-button">×</button>
                <div class="lg:col-span-12">
                    <h3 id="cp_title" class="mb-2">Cookies Policy</h3>
                    <span id="cp_lastUp">Last updated: 08/22/2023</span>
                    <hr class="w-11 h-0.5 mt-0.5 mb-4 ml-0 border-none bg-indigo-600" />
                    <h6 class="mt-7 mb-2.5">Introduction :</h6>
                    <p id="cp_welcome">Welcome to Online Job Portal. This Cookies Policy is designed to help you understand how we use cookies, web beacons, and similar technologies on our website [<a href="www.yourjobportalwebsite.com">www.yourjobportalwebsite.com</a>] to enhance your experience and provide you with relevant information and services. By continuing to use our Website, you consent to the use of these technologies as described in this policy.</p>
                    <h6 id="cp_h1" class="mt-7 mb-2.5">What Are Cookies?</h6>
                    <p id="cp_p1">Cookies are small text files that are stored on your device (computer, tablet, or mobile phone) when you visit certain websites. They are commonly used to remember your preferences, keep you logged in, and provide anonymized tracking data to help website owners understand how users interact with their sites.</p>
                    <h6 id="cp_h2" class="mt-7 mb-2.5">How We Use Cookies ?</h6>
                    <p id="cp_p2">We use cookies for various purposes on Online Job Portal:</p>
                    <ol class="list-decimal ml-6">
                        <li id="cp_li1">Essential Cookies: These cookies are necessary for the basic functionality of our Website. They allow you to navigate the site, log in to your account, and access secure areas. Without these cookies, certain features of the Website may not function properly.</li>
                        <li id="cp_li2">Analytics and Performance Cookies: These cookies help us analyze how visitors use our Website. They provide us with valuable information about which pages are visited most often, how users navigate through the site, and if they encounter any errors. This data helps us improve the overall user experience.</li>
                        <li id="cp_li3">Functionality Cookies: Functionality cookies allow the Website to remember your preferences and choices, such as your preferred language, location, and job search settings. This enables us to provide you with a more personalized experience.</li>
                        <li id="cp_li4">Advertising and Targeting Cookies: These cookies are used to deliver relevant advertisements to you based on your interests and browsing behavior. They also help us measure the effectiveness of our advertising campaigns.</li>
                    </ol>
                    <h6 id="cp_h3" class="mt-7 mb-2.5 italic">Third-Party Cookies</h6>
                    <p id="cp_p3">We may also allow third-party service providers to place cookies on your device through our Website to help us analyze usage statistics, provide you with social sharing features, and deliver advertisements tailored to your interests. These providers have their own privacy policies and may collect your information, including personal data, through the cookies they set.</p>
                    <h6 id="cp_h4" class="mt-7 mb-2.5 italic">Managing Cookies</h6>
                    <p id="cp_p4">Most web browsers allow you to manage your cookie preferences. You can usually set your browser to refuse cookies or to alert you when cookies are being sent. However, please note that blocking or deleting cookies may impact your ability to use certain features of our Website.</p>
                    <h6 id="cp_h5" class="mt-7 mb-2.5 italic">Updates to this Policy</h6>
                    <p id="cp_p5">We may update this Cookies Policy from time to time to reflect changes in technology or applicable laws. When we make changes, we will revise the "Last updated" date at the beginning of this policy. We encourage you to review this policy periodically to stay informed about how we use cookies.</p>
                    <h6 id="cp_h6" class="mt-7 mb-2.5">Contact Us</h6>
                    <p id="cp_p6">If you have any questions about our Cookies Policy, please contact us at [<a class="text-indigo-600 hover:text-gray-500" href="mailto:contact@yourjobportalwebsite.com">contact@yourjobportalwebsite.com</a>].Remember to customize the placeholders and details in the policy to match your website and its practices. Also, consult with legal professionals to ensure that your Cookies Policy complies with relevant laws and regulations.</p>
                    <br><br>
                    <button id="cp_accept" class="btn-outline-reg mfp-close as-button" type="button">Accept Cookies</button>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        ...
        <div id="plan" class="cards-1 px-4 md:px-8 lg:px-16 my-20">
            <h1 id="plan_title" class="text-5xl font-bold text-center mb-12 bg-clip-text text-transparent bg-gradient-to-r from-red-500 via-pink-500 to-pink-400">
                Investment Plan
            </h1>
            <div class="p-6">
        ...
        <div class="pt-4 pb-6 text-center">
            <h1 id="toc_title" class="text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-red-500 via-pink-500 to-pink-400">
                Terms of Contract
            </h1>
        </div>
        ...
        <!-- Short-Term -->
            <div class="bg-gradient-to-br from-black via-gray-500 to-black p-6 rounded-lg flex-1">
                <div class="text-center">
                    <span id="sTerm_title" class="px-6 py-2 mt-5 rounded-xl font-bold text-lg text-white bg-black bg-opacity-20">
                        Short - Term
                    </span>
                    <h3 id="sTerm_duration" class="mt-4 text-white text-xl font-semibold">3 to 7 days</h3>
                </div>
                <p id="sTerm_p1" class="mt-6 mb-4 text-white text-sm md:text-base">
                ...
                <div class="flex justify-center mt-6">
                    <a id="sTerm_a" href="#short-term-details" class="open-popup inline-block bg-transparent text-white font-bold py-3 px-6 rounded-xl shadow-lg transition duration-300 transform hover:bg-transparent hover:text-white">
                        More details 
            ...
            <!-- Contenu du popup statique -->
                        <h2 id="sTerm_h1" class="text-xl sm:text-2xl md:text-3xl font-bold mb-4 text-gray-800">Short-Term</h2>

                        <p id="sTerm_p2" class="text-gray-700 mb-4 text-sm sm:text-base md:text-lg">
                        ...
                        <h3 id="sTerm_h2" class="text-lg sm:text-xl md:text-2xl font-semibold mb-2 text-gray-800">Key Features:</h3>
                        <ul class="list-disc list-inside text-gray-700 mb-4 space-y-1 text-sm sm:text-base md:text-lg">
                            <li id="sTerm_li1"><strong>Duration:</strong> 3–7 days</li>
                            <li id="sTerm_li2"><strong>Liquidity:</strong> Instant access after maturity</li>
                            <li id="sTerm_li3"><strong>Risk:</strong> Low-risk, capital preservation</li>
                            <li id="sTerm_li4"><strong>Returns:</strong> Modest but reliable</li>
                            <li id="sTerm_li5"><strong>Ideal for:</strong> Individuals or businesses needing quick, safe, and flexible investment options</li>
                        </ul>

                        <p id="sTerm_p3" class="text-gray-700 font-semibold text-sm sm:text-base md:text-lg">
                        ...
                        <div class="mt-4 text-right">
                            <button id="sTerm_cls" class="popup-close-bottom bg-blue-600 hover:bg-blue-700 text-white px-3 py-1 rounded">
                                Close
                            </button>
                        </div>
                    </div>
        ...
        <!-- Mean-Term -->
            <div class="bg-gradient-to-br from-black via-gray-500 to-black p-6 rounded-lg flex-1">
                <div class="text-center">
                    <span id="mTerm_title0" class="px-6 py-2 mt-5 rounded-xl font-bold text-lg text-white bg-black bg-opacity-20">
                        Mean - Term
                    </span>
                    <h3 id="mTerm_duration" class="mt-4 text-white text-xl font-semibold">7 to 15 days</h3>
                </div>
                <p id="mTerm_p0" class="mt-6 mb-4 text-white text-sm md:text-base">
                ...
                <div class="flex justify-center mt-6">
                    <a id="mTerm_a" href="#mean-term-details" class="open-popup inline-block bg-transparent text-white font-bold py-3 px-6 rounded-xl shadow-lg">
                        More details 
                        <span class="ml-2 inline-block transform transition-transform duration-300 group-hover:translate-x-1">→</span>
                    </a>
                </div>
            ...
            <!-- Contenu du popup statique -->
                        <h2 id="mTerm_title" class="text-xl sm:text-2xl md:text-3xl font-bold mb-4 text-gray-800">Mean-Term</h2>

                        <p id="mTerm_p1" class="text-gray-700 mb-4 text-sm sm:text-base md:text-lg">
                        ...
                        <h3 id="mTerm_h1" class="text-lg sm:text-xl md:text-2xl font-semibold mb-2 text-gray-800">Key Features:</h3>
                        <ul class="list-disc list-inside text-gray-700 mb-4 space-y-1 text-sm sm:text-base md:text-lg">
                            <li id="mTerm_li1"><strong>Duration:</strong> 7–15 days</li>
                            <li id="mTerm_li2"><strong>Liquidity:</strong> Funds accessible after maturity</li>
                            <li id="mTerm_li3"><strong>Risk:</strong> Low-risk, capital preservation</li>
                            <li id="mTerm_li4"><strong>Returns:</strong> Moderate but consistent</li>
                            <li id="mTerm_li5"><strong>Ideal for:</strong> Individuals or businesses planning for long-term financial objectives</li>
                        </ul>

                        <p id="mTerm_p2" class="text-gray-700 font-semibold text-sm sm:text-base md:text-lg">
                        ...
                        <div class="mt-4 text-right">
                            <button id="mTerm_cls" class="popup-close-bottom bg-blue-600 hover:bg-blue-700 text-white px-3 py-1 rounded">
                                Close
                            </button>
                        </div>
                    </div>
        ...
        <!-- Long-Term -->
            <div class="bg-gradient-to-br from-black via-gray-500 to-black p-6 rounded-lg flex-1">
                <div class="text-center">
                    <span id="lTerm_title" class="px-6 py-2 mt-5 rounded-xl font-bold text-lg text-white bg-black bg-opacity-20">
                        Long - Term
                    </span>
                    <h3 id="lTerm_duration" class="mt-4 text-white text-xl font-semibold">1 to 2 months</h3>
                </div>
                <p id="lTerm_p1" class="mt-6 mb-4 text-white text-sm md:text-base">
                ...
                <div class="flex justify-center mt-6">
                    <a id="lTerm_a" href="#long-term-details" class="open-popup inline-block bg-transparent text-white font-bold py-3 px-6 rounded-xl shadow-lg">
                        More details 
                        <span class="ml-2 inline-block transform transition-transform duration-300 group-hover:translate-x-1">→</span>
                    </a>
                </div>
            ...
            <div id="long-term-details" class="popup mt-20 hidden fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 pointer-events-auto px-4">
                ...
                <!-- Bouton fermeture en X -->
                    ...
                    <!-- Contenu du popup statique -->
                    <h2 id="lTerm_h1" class="text-xl sm:text-2xl md:text-3xl font-bold mb-4 text-gray-800">Long-Term</h2>

                    <p id="lTerm_p2" class="text-gray-700 mb-4 text-sm sm:text-base md:text-lg">
                    ...
                    <h3 id="lTerm_h2" class="text-lg sm:text-xl md:text-2xl font-semibold mb-2 text-gray-800">Key Features:</h3>
                    <ul class="list-disc list-inside text-gray-700 mb-4 space-y-1 text-sm sm:text-base md:text-lg">
                        <li id="lTerm_li1"><strong>Duration:</strong> 1-2 months</li>
                        <li id="lTerm_li2"><strong>Liquidity:</strong> Accessible at maturity</li>
                        <li id="lTerm_li3"><strong>Risk:</strong> Low to moderate, capital growth focus</li>
                        <li id="lTerm_li4"><strong>Returns:</strong> Higher and more reliable than short-term options</li>
                        <li id="lTerm_li5"><strong>Ideal for:</strong> Individuals or businesses needing quick, safe, and flexible investment options</li>
                    </ul>

                    <p id="lTerm_p3" class="text-gray-700 font-semibold text-sm sm:text-base md:text-lg">
                        Take control of your long-term funds with confidence—<span class="text-blue-600">invest smart, invest long!</span>
                    </p>

                    <div class="mt-4 text-right">
                        <button id="lTerm_cls" class="popup-close-bottom bg-blue-600 hover:bg-blue-700 text-white px-3 py-1 rounded">
                        Close
                        </button>
                    </div>
                </div>
        ...
        <div class="max-w-md mx-auto bg-white p-6 rounded-2xl shadow-lg mt-10 mb-10">
            <h2 id="op_title" class="text-2xl font-bold mb-4 text-gray-800">Your opinion</h2>
            ...
            @csrf
                ...
                <!-- Email -->
                <div>
                    <label id="op_email_label" for="email" class="block text-gray-700 font-medium mb-1">Your e-mail *</label>
                    <input type="email" id="email" name="email" placeholder="your@email.com" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" required>
                </div>

                <!-- Avis -->
                <div id="opinion">
                    <label id="op_opinion_label" for="avis" class="block text-gray-700 font-medium mb-1">Your opinion</label>
                ...
                <!-- Bouton Envoyer -->
                <div>
                    <button id="op_send" type="submit" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-xl shadow-lg transition">
                        Send
                    </button>
                </div>
        ...
        <div class="footer">
            <div class="container px-4 sm:px-8">
                <p id="footer_p1" class="mb-8 lg:max-w-3xl lg:mx-auto">Unicorn Madagascar is a web platform of investment and you can reach the team at <a class="text-indigo-600 hover:text-gray-500" href="mailto:e.serasera.malalaka@gmail.com">e.serasera.malalaka@gmail.com</a></p>
        ...
        <script>
            ...
            // Read more functionality for investment plan section
            const para = document.getElementById('text_paragraph');
            ...
            // Détecte le changement du dropdown
