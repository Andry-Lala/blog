...
@section('title', 'Historique de mes investissements')

@section('header')
    <div class="ml-4 flex items-center justify-between">
        <h1 class="text-2xl font-semibold text-gray-900">Historique de mes investissements</h1>
    ...
    <div class="px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white shadow rounded-lg overflow-hidden">
            <div class="px-4 py-5 sm:px-6">
                <h3 class="text-lg leading-6 font-medium text-gray-900">Toutes mes opérations</h3>
            </div>
                                    ...
                                    <div class="flex space-x-2">
                                        ...
                                        @if($investment->status === 'Validé')
                                            <a href="{{ route('investments.invoice', $investment) }}"
                                               class="text-green-500 hover:text-green-600" title="Télécharger la facture">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-6 py-4 text-center text-sm text-gray-500">
                                    Vous n'avez aucun investissement pour le moment.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
