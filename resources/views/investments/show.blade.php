...
@section('header')
    <div class="ml-4 flex items-center justify-between">
        <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Détails de l'Investissement</h1>
    ...
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                        <h3 class="text-lg font-medium text-gray-900 dark:text-white">Informations de l'investissement</h3>
                    </div>
                    <div class="p-6">
                        <dl class="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                            <div>
                                <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Date de soumission</dt>
                                <dd class="mt-1 text-sm text-gray-900 dark:text-white">{{ $investment->created_at->format('d/m/Y H:i') }}</dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Opérateur</dt>
                                <dd class="mt-1 text-sm text-gray-900 dark:text-white">{{ $investment->operator }}</dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Type d'investissement</dt>
                                <dd class="mt-1 text-sm text-gray-900 dark:text-white">{{ $investment->investment_type }}</dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Montant</dt>
                                <dd class="mt-1 text-sm text-gray-900 dark:text-white">{{ number_format($investment->amount, 2, ',', ' ') }} Ar</dd>
                            </div>
                            <div>
                            ...
                            <div>
                                <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Téléphone transaction</dt>
                                <dd class="mt-1 text-sm text-gray-900 dark:text-white">{{ $investment->transaction_phone }}</dd>
                            </div>
                        </dl>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <dl class="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                            <div>
                                ...
                                <dd class="mt-1 text-sm text-gray-900 dark:text-white">{{ $investment->last_name }}</dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Prénom</dt>
                                <dd class="mt-1 text-sm text-gray-900 dark:text-white">{{ $investment->first_name }}</dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Téléphone</dt>
                                <dd class="mt-1 text-sm text-gray-900 dark:text-white">{{ $investment->phone }}</dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Numéro pièce d'identité</dt>
                                <dd class="mt-1 text-sm text-gray-900 dark:text-white">{{ $investment->id_number }}</dd>
                            </div>
                            <div class="sm:col-span-2">
                                <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Adresse</dt>
                                <dd class="mt-1 text-sm text-gray-900 dark:text-white">{{ nl2br($investment->address) }}</dd>
                            </div>
                        </dl>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                        <h3 class="text-lg font-medium text-gray-900 dark:text-white">Notes de l'administrateur</h3>
                    </div>
                    <div class="p-6">
                        <p class="text-sm text-gray-900 dark:text-white">{{ nl2br($investment->admin_notes) }}</p>
                    </div>
                </div>
                @endif
            </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div>
                            ...
                            @else
                                <p class="text-sm text-gray-500 dark:text-gray-400">Non disponible</p>
                            @endif
                        </div>
                ...
                <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                        <h3 class="text-lg font-medium text-gray-900 dark:text-white">Actions administrateur</h3>
                    </div>
...
<div id="processModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden">
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white dark:bg-gray-800">
        <div class="mt-3">
            <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-white">Traiter la demande</h3>
            <div class="mt-2 px-7 py-3">
                <p class="text-sm text-gray-500 dark:text-gray-400">Voulez-vous mettre cette demande en cours de traitement ?</p>
                <div class="mt-4">
                    <label for="admin_notes_process" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Notes (optionnel)</label>
                    <textarea id="admin_notes_process" name="admin_notes" rows="3" class="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white"></textarea>
                </div>
            </div>
    ...
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white dark:bg-gray-800">
        <div class="mt-3">
            ...
            <div class="mt-2 px-7 py-3">
                ...
                <div class="mt-4">
                    <label for="admin_notes_approve" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Notes (optionnel)</label>
                    <textarea id="admin_notes_approve" name="admin_notes" rows="3" class="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white"></textarea>
                </div>
            </div>
            <div class="items-center px-4 py-3">
    ...
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white dark:bg-gray-800">
        <div class="mt-3">
            ...
            <div class="mt-2 px-7 py-3">
                ...
                <div class="mt-4">
                    <label for="admin_notes_reject" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Motif du rejet *</label>
                    <textarea id="admin_notes_reject" name="admin_notes" rows="3" required class="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white"></textarea>
                </div>
            </div>
            <div class="items-center px-4 py-3">
